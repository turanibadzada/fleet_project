...
urlpatterns = [
    ...
    path("order/create/", views.HouseOrderCreateView.as_view(), name="house_order_create"),
    ...
    path("orders/", views.UserHouseOrderLİstView.as_view(), name="house_order_list"),
    path("orders/delete/<id>/", views.UserHouseOrderDeleteView.as_view(), name="order_delete"),
] 